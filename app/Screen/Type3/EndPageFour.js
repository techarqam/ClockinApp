...
import { Container, Card, CardItem, Button, DatePicker, Icon, Header, Left, Body, Right, Title,Form,Picker,Input,Item,Textarea } from 'native-base';
...
export default class EndPageFour extends Component {
    constructor(props) {
        super(props);
        this.state = {
            modalVisible: false,
    ...
    newConfirm() {
        ...
        setTimeout(() => {
            this.setState({modalVisible2:false});
            NavigationService.navigate('PageTypeThree')
        }, 3000);
    }
            ...
            <Container style={{ backgroundColor: '#e4e9ed' }}>
                ...
                <View style={styles.MainView1}>
                    <Form style={{width:'90%',backgroundColor:'white'}}>
                        <Textarea rowSpan={8} style={{paddingTop:20,paddingBottom:20,fontSize:16,marginHorizontal:10}}  value="Wikipedia article or other mainspace page is a concise explanation of the scope of the page. Wikipedia's mobile interface uses descriptions to augment searches, and the Wikipedia App also displays them below each article title." />
                    </Form>
                </View>
                <View style={styles.buttonView}>
                    <Button danger={this.state.ButtonRed1} warning={this.state.ButtonOrange1} rounded  style={styles.buttonstyle1} onPress={() => this.setState({ modalVisible1: true })}>
                        <Text style={{ textAlign: 'center', width: '100%', color: 'white', fontWeight: 'bold', fontSize: 17 }}>END JOB DESCRIPTION</Text>
                    </Button>
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center',backgroundColor:'#0000004b' }}>
                        ...
                        <View style={{ height: '18%', width: '70%', backgroundColor: 'white' }}>
                            <View style={{justifyContent:'center',marginTop:20}}>
                                <Text style={{textAlign:'center',fontSize:17}}>END MY JOB DESCRIPTION</Text>
                            </View>
